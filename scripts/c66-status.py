...
def print_status():
    ...
    if all_ok:
        ...
        print(f"  • Server not running? Run: ./deploy-full-server.sh")
        print(f"  • Network issue? Check: sudo ufw allow 8080/tcp")
        print(f"  • No recent scans? This is normal if no scanning has occurred")

...
WORKDIR = "/home/tim/Desktop/01.mine-management-system"
CHECK_INTERVAL = 10
PYTHON_BIN = "/home/tim/Desktop/01.mine-management-system/venv/bin/python"
app_process = None
app_pid = None
...
# Title for the monitor display
title = "🏴‍☠️ BLACK ARCH SYSTEM MONITOR"
...
# Global DB session setup to avoid leaks
_engine = None
...
def get_dashboard_stats():
    ...
    try:
        ...
        # Do not close engine, just remove session from registry
        db_session.remove()
...
def render_text_display(health_results, issues, avg_time, stats):
    ...
    print(BLACK_ARCH_LOGO)
    print("=" * 60)
    print("🏡 BLACK ARCH SYSTEM - MONITOR")
    print("=" * 60)
...
def run_loop():
    ...
    log(BLACK_ARCH_LOGO)
    log("=== Black Arch System - Monitor Started ===")
